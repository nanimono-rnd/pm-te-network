...
Estimation proceeds over rolling windows of 60 calendar days at 4-hour resolution, advancing by 1 day. Within each window, a node is included only if it has at least 30 days of active trading. The 4-hour resolution yields approximately 1,100--1,400 observations per window, giving a ratio of observations to nodes ($T/N$) of approximately 129 in the primary analysis regime---well above the reliability threshold of $T/N \geq 20$ established in \citet{yang2026te}.
